      ...
      <div className=" h-full mx-auto sm:px-0 lg:px-0 flex flex-col lg:flex-wrap max-w-[1900px]">
        <div className="xl:w-1/3 max-h-3/4 flex flex-col md:px-10 text-center px-5 align-center items-center lg:items-start lg:text-left justify-evenly m-auto h-full lg:max-w-150">
          <h1 className="font-serif text-5xl font-bold text-gray-800 leading-tight">
            An auction platform where winning bids fund a charity of your
            choice.
          </h1>
          <div className="flex gap-3 items-center align-center justify-center mt-5 mb-8">
            <div className="flex  mt-2 ml-1">
              <img
                ...
                alt="User 1"
                className="w-10 h-10 rounded-full object-cover object-center border-2 border-white -ml-2"
              />
              <img
                src="https://images.pexels.com/photos/3482526/pexels-photo-3482526.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt="User 2"
                className="w-10 h-10 rounded-full object-cover object-center border-2 border-white -ml-2"
              />
              <img
            ...
            <p className="text-gray-600 flex-1">
              Join <span className="font-bold text-gray-800">4600+ users</span>{" "}
              and start giving to charity right now.
            </p>
          </div>

          <Link
            to="/listings"
            className="bg-accent-500 text-white px-6 py-3 my-6 rounded-lg shadow-md hover:bg-accent-600 w-fit"
          >
            Browse listings
          </Link>
        </div>
