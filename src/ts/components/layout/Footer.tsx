      ...
      <div className="py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
          ...
          <div>
            <a
              href="/listings"
              className="inline-block bg-accent-400 text-white font-semibold text-sm px-6 py-3 rounded-full shadow-lg hover:bg-accent-500 transition"
            >
              Browse Listings
            </a>
          </div>
          ...
          <div className="flex flex-row flex-wrap m-auto justify-evenly gap-5">
            <div className="flex flex-col text-left lg:w-1/3 lg:min-w-96 ">
              <div className="flex flex-col self-center text-left">
                <p className="text-base text-gray-900 max-w-92">
                  HeartBids is an auction platform designed to facilitate
                  meaningful contributions to charitable causes. By auctioning
                  items, services, and craftsmanship, users support
                  organizations that rely on community-driven funding.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col xl:text-left text-center  min-w-42">
              <div className="flex flex-col self-center xl:text-left text-center">
                <h3 className="text-lg font-semibold text-gray-900 xl:text-left text-center">
                  Company
                </h3>
