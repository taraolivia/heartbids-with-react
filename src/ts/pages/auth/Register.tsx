...
const Register: React.FC = () => {
      ...
      const userData = await HandleRegister({
        ...
        banner: formData.bannerUrl.trim()
          ? {
              ...
              alt: formData.bannerAlt.trim() || "User Banner",
            }
          : undefined,
  ...
  return (
    <div className="min-h-screen mt-20">
      <h1 className="text-4xl text-center font-bold text-primary-700">
        Welcome to HeartBids
      </h1>
      <div className="flex bg-gradient-to-t from-background-50 via-primary-200 to-background-50">
        <div className="max-w-7xl flex flex-wrap-reverse m-auto">
          <div className="md:flex flex-col md:w-1/2 max-w-md mt-5   justify-start gap-4">
            <p className="mt-4 text-right text-gray-600 text-lg">
              Create an account to start bidding, listing items, and support
              charities.
            </p>
            ...
            <form onSubmit={handleSubmit} className="my-8 space-y-8 text-base">
              <div>
                ...
                <input
                  ...
                  name="name"
                  type="text"
                  placeholder="i.e. Heart_Bids"
                  value={formData.name}
                  onChange={handleChange}
                  required
                  className="mt-2 p-3 w-full rounded-2xl border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 text-gray-900"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  name="email"
                  type="email"
                  placeholder="i.e. heart@stud.noroff.no"
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={handleChange}
                  className="h-6 w-6 text-secondary-600 border-gray-300 rounded focus:ring-secondary-500"
                />
                <label className="ml-2 text-base text-gray-900">
                  I am a Venue Manager (Optional)
                </label>
              </div>
              ...
              <div>
                <button
                  type="submit"
                  className="w-full bg-secondary-600 text-white font-semibold py-3 rounded-lg shadow-md hover:bg-secondary-700 focus:outline-none focus:ring-2 focus:ring-secondary-500 focus:ring-offset-2"
                >
                  Create Account
                </button>
              </div>
