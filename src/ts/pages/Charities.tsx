...
const Charities: React.FC = () => {
  ...
  const categories = [
    "All",
    ...new Set(AllCharities.flatMap((charity) => charity.categories)),
  ];

  const filteredCharities =
    selectedCategory && selectedCategory !== "All"
      ? AllCharities.filter((charity) =>
          charity.categories.includes(selectedCategory),
        )
      : AllCharities;
      ...
      <section className="py-16 px-4 min-h-screen">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-gray-800 mb-6">
            All charities on HeartBids
          </h2>
          <p className="text-lg text-gray-600 mb-10">
            Discover the amazing organizations making a difference through
            HeartBids.
          </p>
