...
const CreateListingForm: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-3xl bg-white p-6 rounded-lg shadow-lg">
      ...
      <div><p>All fields are required to create a listing on HeartBids. This ensures that the buyers know what they are bidding on and creates a safe experience for everyone.</p></div>
  ...
  className={`w-full p-3 border rounded-md ${
    errorField.title ? "border-red-500" : "border-gray-300"
  }`}
/>
  ...
  rows={4}
  className={`w-full p-3 border rounded-md ${
    errorField.description ? "border-red-500" : "border-gray-300" 
  }`}
/>
  ...
  className={`w-full p-3 border rounded-md ${
    errorField.tags ? "border-red-500" : "border-gray-300"
  }`}
/>
    ...
    {formData.media?.map((media, index) => (
      <div key={index} className="space-y-2">
        ...
        <input
          ...
          className={`w-full p-3 border rounded-md ${
            errorField.media ? "border-red-500" : "border-gray-300"
          }`}
        />
...
/>
  ...
  timeIntervals={15}
  className={`w-full p-3 border rounded-md ${
    errorField.endsAt ? "border-red-500" : "border-gray-300"
...
/>
  ...
  <div className="flex justify-between items-center">
    ...
    <button
      type="submit"
      disabled={loading}
      className={`mt-4 p-3 rounded-md font-semibold text-white ${
